...
namespace StudentManagementSystem
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n=== Part 5: Skills Processing ===");
            Console.Write("Enter skills (comma separated, e.g., C#,HTML,CSS): ");
            ...
            // Modify one grade manually (e.g., Student 1, Subject 1)
            Console.WriteLine("\nUpdating Student 1, Subject 1 grade to 100...");
            grades[0, 0] = 100;

            // --- Part 7: Jagged Array (Advanced) ---
            Console.WriteLine("\n=== Part 7: Jagged Array (Exam Scores) ===");
            int[][] exams = new int[3][];
            exams[0] = new int[] { 85, 90 };       // Student 1 has 2 exams
            exams[1] = new int[] { 70, 88, 92 };   // Student 2 has 3 exams
            exams[2] = new int[] { 95 };           // Student 3 has 1 exam

            for (int i = 0; i < exams.Length; i++)
            {
                Console.Write($"Student {i + 1} Exam Scores: ");
